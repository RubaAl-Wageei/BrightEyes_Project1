                ...
                <div class="col-lg-8 col-md-8">
                    <div class="blog__details__content">
                        <div class="blog__details__item">
                            <img src="img/blog/details/blog-details1.jpg" alt="">
                            <div class="blog__details__item__title">
                                <span class="tip">BRIGHT-EYES Website</span>
                                <h4>who is BRIGHT-EYES team ?</h4>
                                <ul>
                                    <li>by <span>BRIGHT-EYES team</span></li>
                                    <li>Dec 31, 2022</li>
                        ...
                        <div class="blog__details__desc">
                            <p>A site developed by four trainees of Orange Academy for programming using html, css, javascript, php, mysql .to display and sell glasses </p>
                            <p></p>
                        </div>
